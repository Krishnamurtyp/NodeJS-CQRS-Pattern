...
const getLastMessageSql = 'SELECT * FROM message_store.get_last_stream_message($1)'
const getCategoryMessagesSql = 'SELECT * FROM message_store.get_category_messages($1, $2, $3)' // (1)
const getStreamMessagesSql = 'SELECT * FROM message_store.get_stream_messages($1, $2, $3)'
